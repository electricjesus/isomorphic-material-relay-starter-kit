...
| `graphql/types/`                              | All types, including system types, entity types, connections, etc. | [*](./graphql/types/) |
| `graphql/types/MutationType.js`               | Type that includes all the mutations | [*](./graphql/types/MutationType.js) |
| `graphql/types/QueryType.js`                  | Query type that resolves nodes to entities | [*](./graphql/types/QueryType.js) |
| `graphql/types/ViewerType.js`                 | Current user and entry point for any information retrieved | [*](./graphql/types/ViewerType.js) |
